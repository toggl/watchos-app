...
public var timelineReducer: Reducer<TimeEntriesState, TimelineAction, API> = Reducer { state, action, api in
    switch action {
...
private func loadEntriesEffect(_ api: API) -> Effect<TimelineAction>
{
    return Effect {
        api.loadEntries()
