...
class AppReducerTests: XCTestCase
{
    ...
    func testLoadAllSendsSetEntitiesForAllEntities()
    {
        ...
        let appEnvironment = AppEnvironment(api: api, firebaseAPI: firebaseAPI, keychain: Keychain(), dateService: DateService(), pushTokenStorage: pushTokenStorage, signInWithApple: signInWithApple)
